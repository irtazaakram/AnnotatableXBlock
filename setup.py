#!/usr/bin/env python
"""
Package metadata for annotatable.
"""
import os
import re
import sys
...
VERSION = get_version('annotatable', '__init__.py')
...
setup(
    name='AnnotatableXBlock',
    version=VERSION,
    description="""Annotatable XBlock""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Open edX Project',
    author_email='oscm@openedx.org',
    url='https://github.com/openedx/AnnotatableXBlock',
    packages=find_packages(
        include=['annotatable', 'annotatable.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        'xblock.v1': [
            'annotatable-xblock = annotatable:AnnotatableXBlock',
        ]
    },
    package_data=package_data("annotatable", ["static", "public"]),
