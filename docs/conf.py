...
"""
AnnotatableXBlock documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'AnnotatableXBlock',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/AnnotatableXBlock",
...
#
# html_title = 'AnnotatableXBlock v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Annotatable XBlock',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'annotatable'),
                os.path.join(root_path, 'annotatable/migrations')])
